...
class HomeViewController: UIViewController{
    ...
    var LoadingIcon: UIActivityIndicatorView = UIActivityIndicatorView(style: .medium)
    ...
    func setupTableView(){
        ...
        tableView.register(TotalBalanceViewCell.self, forCellReuseIdentifier: ModelToCellMapper.TotalBalance.rawValue)
        tableView.register(BankAccountCell.self, forCellReuseIdentifier: ModelToCellMapper.Account.rawValue)
        tableView.register(AgreementTableViewHeader.self,
                           forHeaderFooterViewReuseIdentifier: "sectionHeader")
        tableView.register(AccountCellWithIcon.self, forCellReuseIdentifier: ModelToCellMapper.AccountWithIcon.rawValue)
...
#Preview {
    let loginViewController = HomeViewController(agreementViewModel: AgreementViewModel())
...
extension HomeViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: model.identifier.rawValue, for: indexPath) as! CustomAgreementCell
